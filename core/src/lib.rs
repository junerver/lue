...
pub use book::{
    build_txt_index, build_txt_index_lenient, build_whole_book_index, source_fingerprint,
    SourceFingerprint, TxtBook, TxtIndex, TOC_FALLBACK_CHAPTER_CHARS,
};
pub use error::LueError;
pub use extract::{
    extract_docx_docs, extract_epub_docs, extract_html_docs, extract_markdown_docs,
    extract_pdf_docs, extract_rtf_docs,
};
...
pub use tts::{sec_ms_gec, synthesize, audio_payload, DEFAULT_VOICE};
